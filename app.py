...
def save_transcript(summary):
    ...
    os.remove(filename)
    return f'<a href="data:text/plain;base64,{b64}" download="summary.txt">Download Transcript</a>'
...
st.markdown('<p class="footer-text">© v1.2.0 with ✨ new features</p>', unsafe_allow_html=True)
